#  Lampa Plugins (Плагины для приложения Lampa)

Главный плагин — [`market.js`](https://bazzzilius.github.io/scripts/market.js) — позволяет **подключать все перечисленные плагины через настройки приложения**, упрощая процесс их установки и активации.
...
- **[SURS — уникальные подборки](https://aviamovie.github.io/surs.js)** — формирует подборки фильмов и сериалов по разным критериям (жанры, стриминги, популярность, просмотры, кассовые сборы).  
  Автор: *@aviamovie*
...
- **[Сброс субтитров](https://nb557.github.io/plugins/reset_subs.js)** — сбрасывает настройки субтитров по умолчанию.  
  Автор: *@t_anton*
...
>  **Примечание:** Некоторые плагины могут конфликтовать между собой, а некоторые работают только на определённых устройствах (например, на ТВ или Android). Используйте возможности `market.js`, чтобы включать нужные плагины без конфликта.

---

##  Как использовать

1. Установите главный плагин [`market.js`](https://bazzzilius.github.io/scripts/market.js) — он добавит интерфейс для подключения дополнительных плагинов через настройки Lampa.
...
Чтобы добавить свой плагин в этот список, создайте [issue](https://github.com/BazZziliuS/BazZziliuS.github.io/issues) с информацией в следующем формате:
