(function () {
    ...
    function addonStart() {
        ...
        var ads = `<div style="padding: 0.3em 0.3em; padding-top: 0;">
                <div style="background: #3e3e3e; padding: 0.5em; border-radius: 1em; text-align: center;">
                    <a href="https://aeza.net/ru?ref=507375" target="_blank" style="display: inline-block;">
                        <img src="https://i.imgur.com/yJCQucC.png" style="max-width: 100%; border-radius: 0.5em; display: block; margin: 0 auto;" alt="Реклама">
                    </a>
                </div>
            </div>`
