(function () {
    ...
    */
    ...
    const pluginsList = [
        ...
        { component: 'add_interface_plugin', key: 'surs', name: 'Уникальные подборки фильмов и сериалов', description: 'Плагин создает уникальные подборки фильмов и сериалов на главной странице по жанрам, стримингам, популярности, просмотрам и кассовым сборам.', url: 'https://aviamovie.github.io/surs.js', author: '@aviamovie' },
