      ...
      e.on("hover:enter", function () {
        ...
        Lampa.Select.show({
          ...
          onSelect: function b(a) {
            if (a.title === f) {
              Lampa.Activity.push({
                url: "discover/movie?&with_original_language=ru&primary_release_date.lte=2025-12-31&primary_release_date.gte=2020-01-01&vote_average.gte=5&vote_average.lte=9",
              ...
              Lampa.Activity.push({
                url: "discover/movie?vote_average.gte=5&vote_average.lte=9&primary_release_date.lte=2025-12-31&primary_release_date.gte=2015-01-01&with_genres=16&with_original_language=ru",
    ...
    function a() {
      ...
      function b(b) {
        ...
        this.main = function () {
          ...
          var h = g.length + 1;
          Lampa.Arrays.insert(g, 0, Lampa.Api.partPersons(g, 6, "movie", h));
