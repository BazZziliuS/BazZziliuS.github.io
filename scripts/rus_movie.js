    ...
    function c() {
      ...
      c.on("hover:enter", function () {
        ...
        Lampa.Select.show({
          ...
          onSelect: function b(a) {
            if (a.title === d) {
              Lampa.Activity.push({
                url: "discover/movie?&with_original_language=ru&primary_release_date.lte=2025-12-31&primary_release_date.gte=2020-01-01&vote_average.gte=5&vote_average.lte=9.5",
              ...
              Lampa.Activity.push({
                url: "discover/movie?vote_average.gte=5&vote_average.lte=9.5&primary_release_date.lte=2025-12-31&primary_release_date.gte=2015-01-01&with_genres=16&with_original_language=ru",
            ...
            } else if (a.title === "<div class=\"settings-folder\" style=\"padding:0!important\"><div style=\"width:2.2em;height:1.7em;padding-right:.5em\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"1em\" height=\"1em\" viewBox=\"0 0 24 24\"><path fill=\"currentColor\" d=\"M2.185 6.758c-1.495 0-2.193.849-2.193 2.171v1.534c0 1.373.246 1.959 1.235 2.58l.763.474c.618.374.698.651.698 1.453v1.354c0 .393-.18.636-.521.636c-.342 0-.522-.228-.522-.636v-2.125H-.008v2.14c0 1.338.683 2.17 2.159 2.17c1.526 0 2.224-.882 2.224-2.17v-1.666c0-1.272-.326-1.927-1.265-2.529l-.763-.49c-.537-.342-.668-.586-.668-1.469v-1.24c0-.394.18-.637.503-.637c.341 0 .537.247.537.636v2.105h1.656V8.93c0-1.307-.698-2.17-2.19-2.17m2.711.162v1.635h1.17v9.797h1.687V8.555h1.17V6.92zm5.066 0l-.943 11.427h1.672l.23-3.053h1.227l.23 3.053h1.706l-.94-11.427Zm4.985 0v11.427h1.687v-4.78h1.024v3.917c0 .652.276.863.276.863h1.687c.004.004-.272-.207-.272-.863v-2.972c0-.949-.357-1.47-1.22-1.65v-.197c.86-.131 1.3-.768 1.3-1.797V8.929c0-1.257-.747-2.009-2.193-2.009zm5.02 0v1.635h1.169v9.797h1.687V8.555h1.17V6.92zm-8.529 1.55h.2l.399 5.274h-.997zm5.2.004h.437c.522 0 .667.212.667 1.06v1.419c0 .817-.18 1.06-.732 1.06h-.372z\"/></svg></div><div style=\"font-size:1.3em\">Start</div></div>") {
              Lampa.Activity.push({
                url: "discover/tv",
                title: "Start",
                networks: "2493",
      ...
      function m(a) {
        ...
        this.main = function () {
          ...
          var f = [function (a) {
            b.get("movie/now_playing", c, function (b) {
            ...
            b.get("trending/all/day", c, function (b) {
              b.title = Lampa.Lang.translate("title_trend_day");
              a(b);
            }, a);
          }, function (a) {
            b.get("trending/all/week", c, function (b) {
              b.title = Lampa.Lang.translate("title_trend_week");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/movie?vote_average.gte=5&vote_average.lte=9.5&with_original_language=ru&sort_by=primary_release_date.desc&primary_release_date.lte=" + new Date().toISOString().substr(0, 10), c, function (b) {
            ...
            b.get("discover/tv?with_original_language=ru&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("Русские сериалы");
              a(b);
            }, a);
          }, function (a) {
            b.get("movie/upcoming", c, function (b) {
              b.title = Lampa.Lang.translate("title_upcoming");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/movie?vote_average.gte=5&vote_average.lte=9.5&with_genres=16&with_original_language=ru&sort_by=primary_release_date.desc&primary_release_date.lte=" + new Date().toISOString().substr(0, 10), c, function (b) {
            ...
            b.get("movie/popular", c, function (b) {
              b.title = Lampa.Lang.translate("title_popular_movie");
              a(b);
            }, a);
          }, function (a) {
            b.get("trending/tv/week", c, function (b) {
              b.title = Lampa.Lang.translate("title_popular_tv");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/tv?with_networks=2493&sort_by=first_air_date.desc", c, function (b) {
            ...
            b.get("discover/tv?with_networks=2859&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("Premier");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/tv?with_networks=4085&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("KION");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/tv?with_networks=3923&sort_by=first_air_date.desc", c, function (b) {
            ...
            b.get("discover/tv?with_networks=3871&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("OKKO");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/tv?with_networks=3827&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("КиноПоиск");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/tv?with_networks=5806&sort_by=first_air_date.desc", c, function (b) {
            ...
            b.get("discover/tv?with_networks=806&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("СТС");
              a(b);
            }, a);
          }, function (a) {
            b.get("discover/tv?with_networks=1191&sort_by=first_air_date.desc", c, function (b) {
              b.title = Lampa.Lang.translate("ТНТ");
              a(b);
            }, a);
          }, function (a) {
            b.get("movie/top_rated", c, function (b) {
              b.title = Lampa.Lang.translate("title_top_movie");
              b.line_type = "top";
              a(b);
            }, a);
          }, function (a) {
            b.get("tv/top_rated", c, function (b) {
          ...
          var g = f.length + 1;
          Lampa.Arrays.insert(f, 0, Lampa.Api.partPersons(f, 6, "movie", g));
          a.genres.movie.forEach(function (a) {
            var d = function e(d) {
              b.get("discover/movie?with_genres=" + a.id, c, function (b) {
      ...
      if (Lampa.Storage.get("rus_movie_main") !== false) {
        Object.assign(Lampa.Api.sources.tmdb, new m(Lampa.Api.sources.tmdb));
        n();
      }
      function n() {
