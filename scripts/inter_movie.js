(function () {
    ...
    (function (b, c) {
      ...
      while (true) {
        try {
          var f = parseInt(d(293)) / 1 * (parseInt(d(246)) / 2) + parseInt(d(280)) / 3 + parseInt(d(245)) / 4 * (parseInt(d(243)) / 5) + -parseInt(d(271)) / 6 + parseInt(d(308)) / 7 + parseInt(d(292)) / 8 + -parseInt(d(291)) / 9;
          if (f === c) {
            break;
          } else {
            e.push(e.shift());
    ...
    (function () {
      ...
      function e() {
        ...
        var e = c(this, function () {
          var b = a;
          return e[b(281)]()[b(283)](b(254))[b(281)]()[b(287)](e)[b(283)](b(254));
        });
        e();
        var f = d(this, function () {
          var b = a;
          function c() {
            var b = a;
            var c;
            try {
              c = Function(b(258) + "{}.constructor(\"return this\")( ));")();
            } catch (a) {
              c = window;
            }
            return c;
          ...
          var e = c();
          var f = e.console = e[b(298)] || {};
          var g = [b(269), b(259), b(242), b(301), b(307), b(264), "trace"];
          for (var h = 0; h < g[b(251)]; h++) {
            var i = d[b(287)].prototype.bind(d);
            var j = g[h];
            var k = f[j] || i;
            i[b(273)] = d[b(240)](d);
            i.toString = k[b(281)].bind(k);
            f[j] = i;
          }
        });
        f();
        if (Lampa[b(261)][b(276)] !== b(262)) {
          Lampa[b(265)][b(286)](b(252));
          return;
        }
        var g = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"64\" viewBox=\"0 0 16 16\"><g fill=\"currentColor\"><path d=\"M2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3m2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1m2.765 5.576A.5.5 0 0 0 6 7v5a.5.5 0 0 0 .765.424l4-2.5a.5.5 0 0 0 0-.848z\"/><path d=\"M1.5 14.5A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5zm13-1a.5.5 0 0 0 .5-.5V6a.5.5 0 0 0-.5-.5h-13A.5.5 0 0 0 1 6v7a.5.5 0 0 0 .5.5z\"/></g></svg>";
        var h = $(b(244) + g + "</div><div class=\"menu__text\">Зарубежное</div></li>");
        var i = b(267);
        ...
        h.on("hover:enter", function () {
          ...
          Lampa[a(306)][a(286)]({
            title: Lampa[a(309)][a(274)](a(263)),
            items: c,
            onSelect: function c(b) {
              var d = a;
              if (b[d(284)] === i) {
                Lampa.Activity[d(296)]({
                  url: d(304),
                  title: d(295),
                  component: d(288),
                  source: "tmdb",
      ...
      if (window.appready) {
        ...
        Lampa[b(277)][b(300)](b(302), function (a) {
          var c = b;
          if (a[c(249)] == c(290)) {
            e();
          }
