...
(function () {
  ...
  (function () {
    "use strict";
    function c() {
      var e = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"64\" viewBox=\"0 0 16 16\"><g fill=\"currentColor\"><path d=\"M2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3m2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1m2.765 5.576A.5.5 0 0 0 6 7v5a.5.5 0 0 0 .765.424l4-2.5a.5.5 0 0 0 0-.848z\"/><path d=\"M1.5 14.5A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5zm13-1a.5.5 0 0 0 .5-.5V6a.5.5 0 0 0-.5-.5h-13A.5.5 0 0 0 1 6v7a.5.5 0 0 0 .5.5z\"/></g></svg>";
      var f = $("<li class=\"menu__item selector\" data-action=\"inter_movie\"><div class=\"menu__ico\">" + e + "</div><div class=\"menu__text\">Зарубежное</div></li>");
      ...
      f.on("hover:enter", function () {
        ...
        Lampa.Select.show({
          ...
          onSelect: function b(a) {
            if (a.title === g) {
              Lampa.Activity.push({
                url: "discover/tv?first_air_date.lte=2025-12-31&first_air_date.gte=2020-01-01&without_genres=16&with_original_language=ko&vote_average.gte=6&vote_average.lte=10",
                title: "Дорамы",
              ...
              Lampa.Activity.push({
                url: "discover/tv?first_air_date.lte=2025-12-31&first_air_date.gte=2020-01-01&without_genres=16&with_original_language=tr&vote_average.gte=6&vote_average.lte=10",
              ...
              Lampa.Activity.push({
                url: "discover/movie?primary_release_date.lte=2025-12-31&primary_release_date.gte=2020-01-01&without_genres=16&with_original_language=hi&vote_average.gte=6&vote_average.lte=10",
              ...
              Lampa.Activity.push({
                url: "discover/tv?first_air_date.lte=2025-12-31&first_air_date.gte=2020-01-01&vote_average.gte=6&vote_average.lte=10",
                title: "Netflix",
                networks: "213",
                component: "category_full",
                source: "tmdb",
