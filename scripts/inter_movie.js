;(function () {
    ...
    Lampa.Platform.tv()
    ;(function () {
      var _0x9b836d = (function () {
          var _0x1fea20 = true
          return function (_0x57cf96, _0x222967) {
            var _0x396aec = _0x1fea20
              ? function () {
                  if (_0x222967) {
                    var _0x40f4da = _0x222967.apply(_0x57cf96, arguments)
                    return (_0x222967 = null), _0x40f4da
                  }
                }
              : function () {}
            return (_0x1fea20 = false), _0x396aec
          }
        })(),
        _0x55960f = (function () {
          var _0x5e821c = true
          return function (_0x22a7e1, _0xb977a6) {
            var _0xefaa37 = _0x5e821c
              ? function () {
                  if (_0xb977a6) {
                    var _0x11e61a = _0xb977a6.apply(_0x22a7e1, arguments)
                    return (_0xb977a6 = null), _0x11e61a
                  }
                }
              : function () {}
            return (_0x5e821c = false), _0xefaa37
          }
        })()
      ;('use strict')
      function _0x2b2741() {
        var _0x1000ff = _0x9b836d(this, function () {
          return _0x1000ff
            .toString()
            .search('(((.+)+)+)+$')
            .toString()
            .constructor(_0x1000ff)
            .search('(((.+)+)+)+$')
        })
        _0x1000ff()
        var _0x3fb4fa = _0x55960f(this, function () {
          var _0x231dbf = function () {
              var _0x2b9c74
              try {
                _0x2b9c74 = Function(
            ...
            _0x19e7e9 = _0x231dbf(),
            _0x304028 = (_0x19e7e9.console = _0x19e7e9.console || {}),
            _0x1c0e1f = [
              'log',
              'warn',
              'info',
          ...
          for (var _0x3bff83 = 0; _0x3bff83 < _0x1c0e1f.length; _0x3bff83++) {
            var _0x5cba27 = _0x55960f.constructor.prototype.bind(_0x55960f),
              _0x4049b4 = _0x1c0e1f[_0x3bff83],
              _0x228530 = _0x304028[_0x4049b4] || _0x5cba27
            _0x5cba27['__proto__'] = _0x55960f.bind(_0x55960f)
            _0x5cba27.toString = _0x228530.toString.bind(_0x228530)
            _0x304028[_0x4049b4] = _0x5cba27
          }
        })
        _0x3fb4fa()
        var _0x174a88 = $(
            '<li class="menu__item selector" data-action="inter_movie"><div class="menu__ico"><svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 16 16"><g fill="currentColor"><path d="M2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3m2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1m2.765 5.576A.5.5 0 0 0 6 7v5a.5.5 0 0 0 .765.424l4-2.5a.5.5 0 0 0 0-.848z"/><path d="M1.5 14.5A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5zm13-1a.5.5 0 0 0 .5-.5V6a.5.5 0 0 0-.5-.5h-13A.5.5 0 0 0 1 6v7a.5.5 0 0 0 .5.5z"/></g></svg></div><div class="menu__text">Зарубежное</div></li>'
          ),
          _0x5afacb =
        ...
        _0x174a88.on('hover:enter', function () {
          var _0x331ab6 = [
            { title: _0x5afacb },
            {
              title:
          ...
          Lampa.Select.show({
            ...
            items: _0x331ab6,
            onSelect: function _0x4e3a14(_0x1272c5) {
              if (_0x1272c5.title === _0x5afacb) {
                Lampa.Activity.push({
            ...
            onBack: function _0x40c27f() {
              Lampa.Controller.toggle('menu')
            },
          })
        })
        $('.menu .menu__list').eq(0).append(_0x174a88)
      }
      if (window.appready) {
        _0x2b2741()
      } else {
        Lampa.Listener.follow('app', function (_0x3d3468) {
          _0x3d3468.type == 'ready' && _0x2b2741()
        })
      }
    })()
  })()
